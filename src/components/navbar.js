                    ...
                    <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarTogglerDemo01">
                        ...
                        <form role="search">
                            <div class="d-flex align-items-center input-group">
                                ...
                                <input type="search" class="form-control" placeholder="Search a movie title" aria-label="Search" aria-describedby="basic-addon1" style={{width:"500px", maxWidth:"500px"}}/>
